...
func GetAvailableSchemas() []LauncherSchema {
	schemaList := []LauncherSchema{
		...
		LauncherSchemaFromFilename("test_average_equal_validation_against_total.json"),
		LauncherSchemaFromFilename("test_average_equal_or_less_validation_against_total.json"),
		LauncherSchemaFromFilename("test_average_less_validation_against_total.json"),
